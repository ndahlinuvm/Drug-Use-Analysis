...
#run homogenous test for association between age and education at different levels of drugs
drug_data |> 
  group_by(main_df$Meth) |> 
  summarize(odds_ratio = oddsratio(table(Age, Education), rev = "col")$measure[2,1])

           
```

##Conditional Independence for Meth and college conditional on age 
...
##Conditional Independence for Heroin and college conditional on age 
