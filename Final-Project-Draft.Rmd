...
pchisq(q = cond_ind_test_Meth,
       ...
       lower = F)
```
With a test statistic of 57.239 and 30 degrees of freedom the resulting P-value is .00196. With a P-value < .05 we reject our null hypothesis that the relationship between age and Meth use is conditional on education level.
