...
```
With a test statistic of 42.379 and 8 degrees of freedom the resulting P-value is ~0. With a P-value < .05 we reject our null hypothesis. We have strong evidence that the odds ratios for meth use by age at different levels of education are unequal.
