...
I <- n_distinct(drug_data_test$college)
J <- n_distinct(drug_data_test$has_used_Heroin)
K <- n_distinct(drug_data_test$Age)

xtabs(formula = ~ has_used_Heroin + college + Age,
      data = drug_data_test) |> 
  ftable()
...
I <- n_distinct(drug_data_test$college)
J <- n_distinct(drug_data_test$has_used_Meth)
K <- n_distinct(drug_data_test$Age)
  

xtabs(formula = ~ has_used_Meth + Age + college,
      data = drug_data_test) |> 
  ftable()
